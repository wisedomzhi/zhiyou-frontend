...
<template>
  ...
  <van-cell-group>
    ...
    <van-cell center title="账号" is-link @click="toEdit()" :value="user.userAccount" />
    <van-cell center title="性别" is-link @click="toEdit()" :value="user.gender" />
    <van-cell center title="电话" is-link @click="toEdit()" :value="user.phone" />
    <van-cell center title="邮箱" is-link @click="toEdit()" :value="user.email" />
    <van-cell center title="创建时间" is-link @click="toEdit()" :value="user.createTime" />
  </van-cell-group>
